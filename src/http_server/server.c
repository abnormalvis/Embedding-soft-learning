...
{
	send_response(client_fd, "200 OK", "text/html; charset=utf-8", html, strlen(html));
}
...
void handle_request(int client_fd, char *request)
{
	...
	if (strcmp(method, "GET") != 0) {
		send_response(client_fd, "405 Method Not Allowed", "text/html; charset=utf-8",
					 "<h1>405 Method Not Allowed</h1>", strlen("<h1>405 Method Not Allowed</h1>"));
		return;
	}
