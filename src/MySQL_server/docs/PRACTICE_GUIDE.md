...
1. sudo mysql -e "SELECT user,host,plugin FROM mysql.user WHERE user='root';"
2. systemctl status mysql
3.  sudo mysql -e "ALTER USER 'root'@'localhost' IDENTIFIED WITH │ mysql_native_password BY '123456';"
